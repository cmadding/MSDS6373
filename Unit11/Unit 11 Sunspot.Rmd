...
for( i in 1: sims)
{
   SpecDen2 = parzen.wge(gen.aruma.wge(289,s = 10, phi = AR2$phi, theta = AR2$theta, plot = "FALSE"), plot = "FALSE")
   lines(SpecDen2$freq,SpecDen2$pzgram, lwd = 2, col = "red")
}
...
for( i in 1: sims)
{
   ACF2 = acf(gen.aruma.wge(289, s = 10, phi = AR2$phi, theta = AR2$theta, plot =    "FALSE"), plot = "FALSE")
   lines(ACF2$lag ,ACF2$acf, lwd = 2, col = "red")
}
